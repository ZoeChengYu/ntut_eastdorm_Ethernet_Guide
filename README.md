...
## 第貳章   無線網路設定
在我們的宿舍裡，只有交誼廳才能使用北科大的 Wi-Fi，房間內以及走廊是沒有 Wi-Fi 訊號的，因此我們需要走出房間來到交誼廳使用Wi-Fi或是使用手機分享網路到電腦上並使用VPN連線，以進行下一章的登錄裝置與連結IP(只有第一次使用需這樣處理)
### Wi-Fi：NTUT
...
#### 步驟7：出現這個畫面代表成功連上了VPN，接著就能進**[第參章：登錄裝置與連結IP](./README.md#第參章%09%09登錄裝置與連結IP)**
...
### 計算機與網路中心LINE連結
 ...
 [![計算機與網路中心LINE連結](./圖檔/計網中心LINE.png)](https://line.me/R/ti/p/@pnt6913e)
...
|                                                            |  [![電力首頁](./圖檔/圖片22.png)](https://www.aotech.tw/ntut)  |            [![客服中心](./圖檔/圖片23.png)](https://www.aotech.tw/ntut/content_us.php)            |       [![啟用電力](./圖檔/圖片24.png)](https://www.aotech.tw/ntut_power)       |
| :--------------------------------------------------------: | :-----------------------------: | :------------------------------------------------: | :---------------------------------------: |
